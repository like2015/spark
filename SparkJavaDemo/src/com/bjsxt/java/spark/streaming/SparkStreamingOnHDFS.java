...
public class SparkStreamingOnHDFS {
	public static void main(String[] args) {
		...
		final String checkpointDirectory = "hdfs://hadoop1:9000/library/SparkStreaming/CheckPoint_20170416";
	...
	private static JavaStreamingContext createContext(String checkpointDirectory,SparkConf conf) {
		...
		/**
		 * 监控的是HDFS上的一个目录，监控文件数量的变化     文件内容如果追加能监控到吗？监控不到。。。。。。。。
		 */
		JavaDStream<String> lines = ssc.textFileStream("hdfs://hadoop1:9000/hdfs11111/");
